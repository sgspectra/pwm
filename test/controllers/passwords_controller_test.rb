...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference('Password.count') do
      post passwords_url, params: { password: { login: @password.login, password: @password.password, site: @password.site } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { login: @password.login, password: @password.password, site: @password.site } }
